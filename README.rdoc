...
It is currently being used in {O Que Vai Passar}[http://fernandobrito.com/oquevaipassar] project, updating the {@OQueVaiPassar}[http://twitter.com/oquevaipassar] Twitter profile.
...
* Now that you have the movies, you can update Twitter with the best movies
    ...
    rake twitter:update GROUP=Telecine TIME=Afternoon TOP=2 UPDATE=false --trace
